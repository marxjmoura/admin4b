...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var _jquery=_interopRequireDefault(require("jquery")),_fileManagerType=_interopRequireDefault(require("./file-manager-type")),_fileManagerMaxsize=_interopRequireDefault(require("./file-manager-maxsize"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,r){for(var t=0;t<r.length;t++){var a=r[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}function _createClass(e,r,t){return r&&_defineProperties(e.prototype,r),t&&_defineProperties(e,t),e}var NAME="fileManager",NAMESPACE="admin4b.".concat(NAME),DataAttribute={DATA_MAXSIZE:"data-maxsize",DATA_TYPE:"data-type"},Event={ON_CLICK:"click.".concat(NAMESPACE),ON_CHANGE:"change.".concat(NAMESPACE),TRIGGER_CLICK:"click",TRIGGER_CHANGE:"file:change"},Error={MAXSIZE:"maxsize",TYPE:"type"},Selector={DATA_TOGGLE:'[data-toggle="file-manager"]'},FileManager=function(){function e(r){_classCallCheck(this,e),this._element=r}return _createClass(e,[{key:"validate",value:function(e){var r=(0,_jquery.default)(this._element).attr(DataAttribute.DATA_MAXSIZE),t=(0,_jquery.default)(this._element).attr(DataAttribute.DATA_TYPE);e.errors=[],new _fileManagerMaxsize.default(e).isValid(r)||e.errors.push(Error.MAXSIZE),new _fileManagerType.default(e).isValid(t)||e.errors.push(Error.TYPE)}},{key:"read",value:function(e,r){var t=new FileReader;t.readAsDataURL(e),t.onload=function(t){e.dataURL=t.target.result,r()}}}],[{key:"jQueryPlugin",value:function(){return this.each(function(){var r=new e(this),t=(0,_jquery.default)(this),a=(0,_jquery.default)("<input/>").attr("type","file");a.on(Event.ON_CHANGE,function(){var e=a.get(0).files[0];e&&(r.validate(e),r.read(e,function(){t.trigger(Event.TRIGGER_CHANGE,e)}))}),t.on(Event.ON_CLICK,function(){return a.trigger(Event.TRIGGER_CLICK)})})}}]),e}();_jquery.default.fn[NAME]=FileManager.jQueryPlugin,_jquery.default.fn[NAME].Constructor=FileManager,_jquery.default.fn[NAME].noConflict=function(){return _jquery.default.fn[NAME]=FileManager.jQueryPlugin},(0,_jquery.default)(Selector.DATA_TOGGLE).fileManager();var _default=FileManager;exports.default=_default;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var _jquery=_interopRequireDefault(require("jquery"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var r=0;r<t.length;r++){var a=t[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}function _createClass(e,t,r){return t&&_defineProperties(e.prototype,t),r&&_defineProperties(e,r),e}var NAME="sidebar",NAMESPACE="admin4b.".concat(NAME),ClassName={SHOW:"show"},Event={ON_CLICK:"click.".concat(NAMESPACE),HIDE:"hide",SHOW:"show"},Selector={DATA_TOGGLE:'[data-toggle="sidebar"]',SIDEBAR:".app-sidebar"},Sidebar=function(){function e(t){_classCallCheck(this,e),this._element=t}return _createClass(e,[{key:"show",value:function(){(0,_jquery.default)(this._element).addClass(ClassName.SHOW)}},{key:"hide",value:function(){(0,_jquery.default)(this._element).removeClass(ClassName.SHOW)}}],[{key:"jQueryPlugin",value:function(t){return this.each(function(){var r=new e(this);switch(t){case Event.SHOW:r.show();break;case Event.HIDE:r.hide()}})}}]),e}();_jquery.default.fn[NAME]=Sidebar.jQueryPlugin,_jquery.default.fn[NAME].Constructor=Sidebar,_jquery.default.fn[NAME].noConflict=function(){return _jquery.default.fn[NAME]=Sidebar.jQueryPlugin},(0,_jquery.default)(document).on(Event.ON_CLICK,Selector.DATA_TOGGLE,function(){Sidebar.jQueryPlugin.call((0,_jquery.default)(Selector.SIDEBAR),Event.SHOW)}).on(Event.ON_CLICK,function(e){(0,_jquery.default)(e.target).closest(Selector.DATA_TOGGLE).length||(0,_jquery.default)(e.target).closest(Selector.SIDEBAR).length||Sidebar.jQueryPlugin.call((0,_jquery.default)(Selector.SIDEBAR),Event.HIDE)});var _default=Sidebar;exports.default=_default;
